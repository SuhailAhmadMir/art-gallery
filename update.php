...
if(isset($_POST["update"]))
{
    ...
    $query = "UPDATE `tbl_images` SET `id`='$id',`name` ='$file',`artname`='$artname',`des`='$description' WHERE `id`='$id'";
...
<div class="container" style="width:500px;"><br/>
             ...
             <h3 align="center" class="text-white">Update and Display Images Here</h3>
